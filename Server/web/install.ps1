...
#  Ни служб, ни прав администратора. Из реестра трогается ровно одна
#  запись — PATH пользователя, и `ferry uninstall` убирает её обратно.
#
#  Удалить: ferry uninstall — убирает бинарь, настройки и запись из PATH.
#
