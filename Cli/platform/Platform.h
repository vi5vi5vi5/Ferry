...
// Положить текст в буфер обмена. Умеет только Windows: там буфер один и
// системный. На Linux его нет у сервера, куда зашли по ssh, а на столе он
// у каждого окружения свой, так что там — честное false.
